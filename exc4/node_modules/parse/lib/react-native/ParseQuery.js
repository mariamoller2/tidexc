...
var ParseQuery = function () {
  ...
  return (0, _createClass2.default)(ParseQuery, [{
    ...
    value: function (pipeline, options) {
      ...
      if ((options == null ? void 0 : options.rawValues) !== undefined) {
        params.rawValues = options.rawValues;
      }
      if ((options == null ? void 0 : options.rawFieldNames) !== undefined) {
        params.rawFieldNames = options.rawFieldNames;
      }
      var aggregateOptions = _ParseObject.default._getRequestOptions(options);
